...
(function () {
  ...
  // Roles válidos para edición (normalizados en firebase-config-caritas.js)
  const rol = getRol();
  const canEdit = ["Administrador", "Editor"].includes(rol);
  ...
  window.initCalendario = initCalendar;
